  ...
  return (
    <div className="max-w-4xl mx-auto text-center space-y-10">
      ...
      <div className="grid gap-6 sm:grid-cols-2">
        ...
        >
          <div
            className="absolute inset-0 opacity-20 bg-[radial-gradient(circle_at_top,_white,transparent)]"
            aria-hidden="true"
          />
          <div className="relative flex flex-col h-full text-white space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-white/80 text-sm leading-relaxed">
                Accede a la gestión integral de tus propiedades en venta. Podrás
                crear, editar, publicar y dar de baja toda la información clave
                desde un solo lugar.
              </p>
            </div>
        ...
        >
          ...
          <div className="relative flex flex-col h-full text-white space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-white/80 text-sm leading-relaxed">
                Accede a la gestión integral de tus propiedades en alquiler.
                Podrás crear, editar, publicar y dar de baja toda la información
                clave desde un solo lugar.{" "}
              </p>
            </div>
            <span className="mt-auto inline-flex items-center gap-2 text-sm font-semibold text-white/90 group-hover:text-white">
              Explorar alquiler
