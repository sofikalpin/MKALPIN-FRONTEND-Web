...
const Admin = () => {
  const { properties = [], isLoading, error } = useAdminData("all");
  ...
  const statCards = [
    {
      ...
      values: [
        {
          label: `${safeStats.propiedadesDisponibles} Disponibles`,
          color: "text-green-600",
        },
        {
          label: `${safeStats.propiedadesOcupadas} Ocupadas`,
          color: "text-blue-600",
        },
      ],
      trend: 5,
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Resumen general de la gestión inmobiliaria
            </p>
          </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <h3 className="font-semibold text-gray-900">
                  {property.title || property.tipo} -{" "}
                  {property.address || property.direccion}
                </h3>
                <p className="text-sm text-gray-600">
                  $
                  {(property.price || property.precio)?.toLocaleString() ||
                    "Precio no definido"}
                </p>
              </div>
              <span
