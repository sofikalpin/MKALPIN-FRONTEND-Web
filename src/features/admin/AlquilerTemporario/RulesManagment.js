    ...
    <div className="p-4 border rounded">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <input
          ...
          onChange={(e) =>
            setLocalRules({ ...localRules, checkIn: e.target.value })
          }
        ...
        <input
          ...
          onChange={(e) =>
            setLocalRules({ ...localRules, checkOut: e.target.value })
          }
          className="p-2 border rounded"
        />
        <input
          ...
          onChange={(e) =>
            setLocalRules({ ...localRules, cancellationPolicy: e.target.value })
          }
          className="p-2 border rounded"
        />
        <input
          ...
          onChange={(e) =>
            setLocalRules({ ...localRules, houseRules: e.target.value })
          }
          className="p-2 border rounded"
        />
        <button
