            ...
            return (
              ...
              >
                <div className="flex items-start space-x-4">
                  <div
                    className={`p-3 rounded-full ${getIconBg(actividad.color)}`}
                  >
                    <Icon
                      className={`${getIconColor(actividad.color)}`}
                      size={20}
                    />
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span
                        className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getColorClasses(actividad.color)}`}
                      >
                        {actividad.tipo}
                      </span>
                    </div>
