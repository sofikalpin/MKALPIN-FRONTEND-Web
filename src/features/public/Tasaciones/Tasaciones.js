  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.status) {
        ...
        setError(
          data.message || "No se pudo procesar la solicitud de tasación",
        );
      }
    } catch (error) {
          ...
          {!successMessage && (
            <div className="mb-8 relative z-10">
              ...
              <div className="flex justify-between text-xs text-gray-500">
                <span
                  className={step >= 1 ? "font-semibold text-blue-600" : ""}
                >
                  Propiedad
                </span>
                <span
                  className={step >= 2 ? "font-semibold text-blue-600" : ""}
                >
                  Características
                </span>
                <span
                  className={step >= 3 ? "font-semibold text-blue-600" : ""}
                >
                  Contacto
                </span>
              </div>
            ...
            >
              <div className="text-center bg-gradient-to-br from-blue-50 to-indigo-50 p-8 rounded-2xl shadow-inner">
                ...
                <p className="text-sm text-blue-600 mt-4">
                  Nos comunicaremos utilizando los datos de contacto
                  proporcionados.
                </p>
                {tasacionRequestId && (
