      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="space-y-6">
            <h1 className="text-2xl font-bold">
              MARCELO KALPIN NEGOCIOS INMOBILIARIOS
            </h1>
            <p className="text-gray-400 text-sm">Mat. C.U.C.I.C.B.A 7025</p>
            <div className="flex space-x-4 md:ml-20">
              <a
                href="https://www.facebook.com/p/Mkalpin-Negocios-Inmobiliarios-100063507733126/?locale=es_LA"
                target="_blank"
              ...
              <a
                href="https://api.whatsapp.com/message/L4HL64FWSL4UH1?autoload=1&app_absent=0"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://youtube.com/@marcelokalpinnegociosinmob298?si=IZsrQdlpxIAxD2dg"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.zonaprop.com.ar/inmobiliarias/marcelo-kalpin-negocios-inmobilarios_30057843-inmuebles.html"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2025 MKalpin Negocios Inmobiliarios. Todos los derechos
            reservados.
          </p>
