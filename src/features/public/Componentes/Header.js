        ...
        <div className="flex items-center">
          <div className="flex-none md:mr-8 flex-1 md:flex-none flex justify-center md:justify-start">
            <Link to="/">
              <img
                src={logo}
                alt="Logo"
                className="h-14 md:h-24 cursor-pointer"
              />
            </Link>
          </div>
          ...
          <div className="hidden md:block flex-none ml-8">
            {user ? (
              <Link
                to="/perfil"
                className="text-white bg-blue-600 hover:bg-blue-700 font-bold rounded-md border border-blue-600 px-5 py-3 text-xl"
              >
                Perfil
              </Link>
            ) : (
