...
const InmobiliariaLanding = () => {
  ...
  const handleSearch = () => {
    ...
    switch (activeTab) {
      ...
      case "alquilerTemp":
        ...
        if (guestsInfo.adults)
          queryParams.append("adultos", guestsInfo.adults.toString());
        if (guestsInfo.children)
          queryParams.append("ninos", guestsInfo.children.toString());
        if (guestsInfo.rooms)
          queryParams.append("habitacionesFiltro", guestsInfo.rooms.toString());
        break;
      default:
        path = "/venta";
        queryParams.append("transaccionTipo", "Venta");
  ...
  const carouselItems = carouselImages.map((item) => ({
    ...item,
    type: "image",
  }));
    ...
    if (!isHoveringProperties) {
      interval = setInterval(() => {
        setCurrentProperty((prev) =>
          prev === propiedadesDestacadas.length - 1 ? 0 : prev + 1,
        );
      }, 5000);
    }
  ...
  useEffect(() => {
    if (!mapRef.current && mapContainerRef.current) {
      ...
      L.marker(officeCoordinates)
        .addTo(map)
        .bindPopup(
          "Nuestra Oficina Central: Florida 142, oficina: 8° i (Edificio Boston)",
        )
        .openPopup();
  ...
  const prevProperty = () => {
    setCurrentProperty((prev) =>
      prev === 0 ? propiedadesDestacadas.length - 1 : prev - 1,
    );
  };
        ...
        <div className="max-full mx-auto px-4 sm:px-6 lg:px-8 h-full">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Descubre nuestras propiedades más exclusivas seleccionadas
                  ...
                  <div className="bg-white p-8 rounded-lg shadow-xl max-w-md w-full mx-4">
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-gray-600 text-center mb-6">
                        Hemos recibido tu mensaje. Te responderemos a la
                        brevedad.
                      </p>
                      <button
              ...
              >
                <div className="bg-white rounded-xl shadow-lg overflow-hidden mx-4">
                  <div
                    ...
                    style={{
                      transform: `translateX(-${currentProperty * 100}%)`,
                    }}
                  >
                      ...
                      <div key={propiedad.id} className="w-full flex-shrink-0">
                        <div className="flex flex-col lg:flex-row">
                          ...
                          <div className="p-8 lg:w-1/2 flex flex-col justify-center">
                            ...
                            <button
                              className="block w-full text-center bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-6 rounded-lg transition-colors duración-300"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600">
                En <strong>Mkalpin Negocios Inmobiliarios</strong>, nos
                especializamos en ofrecer soluciones inmobiliarias integrales
                tanto para clientes particulares como inversores. Con más de 8
                años de experiencia en el mercado, nos hemos consolidado como
                líderes en el sector, gracias a nuestro compromiso con la
                excelencia y la satisfacción de nuestros clientes.
              </p>
              <p className="text-lg text-gray-600">
                Nuestro equipo de profesionales altamente capacitado está
                dedicado a brindarte un servicio personalizado, adaptado a tus
                necesidades específicas. Ya sea que estés buscando comprar,
                vender, alquilar o invertir en propiedades, estamos aquí para
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Estamos aquí para responder tus preguntas y ayudarte en lo que
              necesites
            </p>
          </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-2 text-left">
                      ...
                      <p className="text-gray-600 mt-1">
                        Florida 142, oficina: 8° i (Edificio Boston), Ciudad
