...
const Alquiler = () => {
    ...
    (propertiesToDisplay) => {
      ...
      propertiesToDisplay.forEach((propiedad) => {
        if (
          ...
          typeof propiedad.coordenadas.lat === "undefined" ||
          typeof propiedad.coordenadas.lng === "undefined"
        ) {
          console.warn(
            `Propiedad con ID ${propiedad.idPropiedad} no tiene coordenadas válidas. Saltando marcador.`,
          );
          return;
        }

        const isSelected =
          propiedadSeleccionada?.idPropiedad === propiedad.idPropiedad;
  ...
  useEffect(() => {
    if (propiedadSeleccionada && mapRef.current) {
      ...
      markersRef.current.forEach((marker) => {
        ...
        if (markerElement) {
          if (
            marker.options.propiedadId === propiedadSeleccionada.idPropiedad
          ) {
            ...
            markerElement.parentNode.classList.remove(
  ...
  const habitacionesOptions = [
    ...new Set(propiedades.map((p) => p.habitaciones)),
  ].sort((a, b) => a - b);
  const banosOptions = [...new Set(propiedades.map((p) => p.banos))].sort(
    (a, b) => a - b,
  );
          ...
          <div className="w-full md:w-3/4 space-y-6">
            ...
            <div>
              ...
              {loading ? (
                ...
                <div
                  className="bg-red-100 text-red-800 p-4 rounded-md mb-4"
                  role="alert"
                >
                    ...
                    >
                      <div className="h-52 bg-gray-200 relative">
                          ...
                          <img
                            src={
                              ...
                              propiedad.imagenes.length > 0
                                ? propiedad.imagenes[0].rutaArchivo ||
                        ...
                        <div className="absolute top-0 left-0 right-0 p-3 flex justify-between items-start">
                          ...
                          <button
                            onClick={(e) =>
                              toggleFavorito(propiedad.idPropiedad, e)
                            }
                          ...
                          >
                            <Bookmark
                              size={18}
                              className={
                                propiedad.favorito ? "fill-current" : ""
                              }
                            />
                          </button>
                        </div>
                      ...
                      <div className="p-5">
                        ...
                        <button
                          onClick={() =>
                            navigate(
                              `/alquiler/detalle/${propiedad.idPropiedad}`,
                            )
                          }
