...
export default function Propiedades() {
  ...
  const propiedadesFiltradas = propiedades.filter((prop) => {
    const cumpleTransaccion = filtroTransaccion
      ? prop.transaccion === filtroTransaccion
      : true;
              ...
              >
                ...
                <p className="text-gray-700 mb-4 font-medium">
                  {prop.tipoUsuario === "Locador" ? (
                    ...
                    <span>
                      <span className="font-semibold">Alquilado por:</span>{" "}
                      {prop.inquilino}
                    </span>
                  )}
                </p>
                ...
                {prop.transaccion === "Alquiler Temporal" && (
                  <button className="w-full mt-4 p-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
                    Ver más
                  </button>
                )}
              </div>
