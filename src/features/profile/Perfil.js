...
const Perfil = () => {
  ...
  const cargarFotoExistente = useCallback(
    async (userData = user) => {
      ...
      try {
        ...
        if (response.data && response.data.status) {
          const newPhotoUrl =
            ...
            (response.data.user && response.data.user.fotoRuta) ||
            response.data.value?.fotoRuta;
          ...
          const errorMessage =
            ...
            "No se pudo actualizar la foto. Por favor, inténtalo de nuevo.";
        ...
        if (uploadError.response) {
          ...
          errorMessage =
            "La solicitud está tardando demasiado. Por favor, verifica tu conexión e inténtalo de nuevo.";
        }
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
              ...
              <div className="pt-20 p-8">
                ...
                <div className="flex items-center justify-center gap-3 mb-6">
                  <span
                    className={`inline-flex px-4 py-1.5 rounded-lg text-sm font-medium text-white ${getRoleBadgeColor(user.idrol)}`}
                  >
                ...
                <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto text-sm">
                  ...
                  <div className="bg-slate-50 border border-slate-200 rounded-lg p-4 text-center sm:col-span-1">
                    ...
                    <div className="font-medium">
                      {formatDate(user.fechaActualizacion)}
                    </div>
                  </div>
                </div>
              </div>
